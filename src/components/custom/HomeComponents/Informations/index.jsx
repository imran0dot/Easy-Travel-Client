...
const Informations = () => {
    ...
    return (
        <div style={styled}>
            <Container>
                <div className='grid lg:grid-cols-2 gap-10 py-36 items-center justify-center'>
                    <div>
                        <img src={img} className='rounded-lg' alt="" />
                    </div>

                    <div className='text-white flex flex-col gap-4 items-start text-lg'>
                        <Title title="Adventure Travel" subTitle="Embrace the Thrill of the Unknown" className="text-white" />
